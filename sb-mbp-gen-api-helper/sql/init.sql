...
CREATE TABLE `ah_interface`  (
  ...
  `yapi_tags` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Yapi的Tags',
...
CREATE TABLE `ah_project`  (
  ...
  `yapi_token` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Yapi的Token',
  `yapi_url` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Yapi的请求地址',
