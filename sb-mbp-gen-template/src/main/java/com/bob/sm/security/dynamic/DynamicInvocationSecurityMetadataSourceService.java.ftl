...
import ${packageName}.dto.criteria.filter.IntegerFilter;
...
public class DynamicInvocationSecurityMetadataSourceService implements
    ...
    public void loadResourceDefine() {
        ...
        systemPermissionCriteria.setCurrentLevel(currentLevelFilter);
        List<SystemPermission> permissionList = systemPermissionMapper.selectList(
                new QueryWrapper<SystemPermission>().eq("current_level", 2));
