...
//    @Pointcut("execution(* ${packageName}.web.rest.*Resource.*(..))")
//    public void pointCutAll(){}

    @Pointcut("execution(* ${packageName}.web.rest.*Resource.get*(..))")
    public void pointCutGet(){}

    @Pointcut("execution(* ${packageName}.web.rest.*Resource.create*(..))")
    public void pointCutCreate(){}

    @Pointcut("execution(* ${packageName}.web.rest.*Resource.update*(..))")
