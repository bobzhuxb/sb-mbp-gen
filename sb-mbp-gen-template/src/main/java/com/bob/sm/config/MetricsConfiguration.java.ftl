...
//    public MetricsConfiguration(PropertiesHelp propertiesHelp, CacheManager cacheManager) {
...
//        }
//        if (propertiesHelp.getMetrics().getJmx().isEnabled()) {
//            log.debug("Initializing Metrics JMX reporting");
//            JmxReporter jmxReporter = JmxReporter.forRegistry(metricRegistry).build();
//            jmxReporter.start();
//        }
//        if (propertiesHelp.getMetrics().getLogs().isEnabled()) {
...
//                .build();
//            reporter.start(propertiesHelp.getMetrics().getLogs().getReportFrequency(), TimeUnit.SECONDS);
//        }
//    }
//
//    @Override
...
//
//        if (propertiesHelp.getMetrics().getPrometheus().isEnabled()) {
//            String endpoint = propertiesHelp.getMetrics().getPrometheus().getEndpoint();
//
