...
public class YmlConfig {
     ...
     * 是否开启远程权限系统认证
     */
    @Value("${microservice.remote-authorization}")
    private String remoteAuthorization;

    /**
     * 权限系统接口协议前缀
     */
    @Value("${microservice.remote-protocol-prefix}")
    private String remoteProtocolPrefix;

    /**
     * 权限系统IP
     */
    @Value("${microservice.authorization-ip}")
    private String remoteAuthorizationIp;

    /**
     * 权限系统端口号
     */
    @Value("${microservice.authorization-port}")
    private String remoteAuthorizationPort;

    /**
     * 权限系统远程登录认证URL
     */
    @Value("${microservice.remote-authenticate-url}")
    private String authenticateUrl;

    /**
     * 权限系统远程授权权限URL
     */
    @Value("${microservice.remote-authorization-url}")
    private String authorizationUrl;

    /**
     * 权限系统远程注册权限许可信息URL
     */
    @Value("${microservice.remote-register-permission-url}")
    private String registerPermissionUrl;

    /**
     * 权限系统远程加载当前用户数据URL
     */
    @Value("${microservice.remote-load-current-user-url}")
    private String loadCurrentUserUrl;

    /**
     * 权限系统远程删除用户URL
     */
    @Value("${microservice.remote-delete-user-url}")
    private String deleteUserUrl;

    /**
     * 权限系统远程新增或更新用户URL
     */
    @Value("${microservice.remote-add-or-update-user-url}")
    private String addOrUpdateUserUrl;

    /**
     * 权限系统远程获取全量数据字典
     */
    @Value("${microservice.remote-load-dictionary-url}")
